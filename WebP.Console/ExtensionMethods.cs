...
namespace XnaFan.ImageComparison
{
    public static class ExtensionMethods
    {
        ...
        public static double PercentageDifference(this Image img1, Image img2, byte threshold = 3)
        {
            ...
            return diffPixels / 4096d;
            //return diffPixels / Convert.ToDouble(img1.Width * img1.Height);
        }
        ...
        public static byte[,] GetDifferences(this Image img1, Image img2)
        {
            ...
            Bitmap thisOne = (Bitmap)img1.Resize(size, size).GetGrayScaleVersion();
            Bitmap theOtherOne = (Bitmap)img2.Resize(size, size).GetGrayScaleVersion();

            //Bitmap thisOne = (Bitmap)img1.GetGrayScaleVersion();
            //Bitmap theOtherOne = (Bitmap)img2.GetGrayScaleVersion();

            byte[,] differences = new byte[size, size];
        ...
        public static byte[,] GetGrayScaleValues(this Image img)
        {
           ...
           // using (Bitmap thisOne = (Bitmap)img.Resize(16, 16).GetGrayScaleVersion())
            using (Bitmap thisOne = (Bitmap)img.Resize(size, size).GetGrayScaleVersion())
            //using (Bitmap thisOne = (Bitmap)img.GetGrayScaleVersion())
            {
